        ...
        "Choices": [
          ...
          },
          {
            "And": [
              ...
              {
                "Or": [
                  { "Variable": "$.ecsResponse.Services[0].Deployments[0].Status", "StringEquals": "ROLLBACK_IN_PROGRESS" },
                  { "Variable": "$.ecsResponse.Services[0].Deployments[0].Status", "StringEquals": "STOPPED" },
                  { "Variable": "$.ecsResponse.Services[0].Deployments[0].Status", "StringEquals": "ROLLBACK_FAILED" },
                  { "Variable": "$.ecsResponse.Services[0].Deployments[0].Status", "StringEquals": "ROLLBACK_COMPLETED" }
                ]
              }
            ],
